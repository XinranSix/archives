...
public class CommonConst {
     ...
     * 七牛云
     */
    public static final String ACCESS_KEY = "DTN8dumP0z6hVpAO0ltTHgLtZ9EiKkshPBkOHZT1";

    public static final String SECRET_KEY = "LVFqPB0n7E8EiZSU3Oh9nuKRZHD_CGeicqPGKI5F";

    public static final String BUCKET = "asguyeduygsey";

    public static final String DOWNLOAD_URL = "http://rok6gndrn.hd-bkt.clouddn.com/";
